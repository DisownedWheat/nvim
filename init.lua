      ...
      on_attach = function(client, bufnr)
        ...
        local function organizeImports()
          ...
          client:request('workspace/executeCommand', params, function(err)
            if err ~= nil then vim.notify(('Error on organizeImports call %s'):format(err.message), vim.log.levels.ERROR) end
          end, bufnr)
        end
        ...
        vim.api.nvim_create_autocmd('BufWritePre', {
          ...
          callback = function()
            ...
            vim.lsp.buf.format {
              bufnr = bufnr,
              filter = function(c) return c.name == 'null-ls' or c.name == 'oxfmt' end,
            }
          end,
        })
...
do
  ...
  require('conform').setup {
    ...
    formatters_by_ft = {
      ...
      ['javascript-react'] = { 'prettierd', 'prettier', stop_after_first = true },
      ['typescript-react'] = { 'prettierd', 'prettier', stop_after_first = true },
    },
  }
